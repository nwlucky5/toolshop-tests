import { AccountPage } from '@_src/ui/pages/account.page';
import { CheckoutPage } from '@_src/ui/pages/checkout.page';
import { ContactPage } from '@_src/ui/pages/contact.page';
...
import { OtherPage } from '@_src/ui/pages/other.page';
import { PowerToolsPage } from '@_src/ui/pages/power-tools.page';
import { ProductPage } from '@_src/ui/pages/product.page';
import { RegisterPage } from '@_src/ui/pages/register.page';
import { RentalsPage } from '@_src/ui/pages/rentals.page';
import { SpecialToolsPage } from '@_src/ui/pages/special-tools.page';
import { CheckoutBillingAddressView } from '@_src/ui/views/checkout-billing-address.view';
import { CheckoutCartView } from '@_src/ui/views/checkout-cart.view';
import { CheckoutLoginView } from '@_src/ui/views/checkout-login.view';
import { CheckoutPaymentView } from '@_src/ui/views/checkout-payment.view';
